...
public class HudRenderCallbackClass {
	...
	private void lookNorth(Vec3d pos) {
		...
		client.player.lookAt(EntityAnchorArgumentType.EntityAnchor.FEET, vec3d);
		if (Config.get(Config.getNarratorkey()))
			client.player.sendMessage(new TranslatableText("narrate.nccbyshoaibkhan.north"), true);
	}
	...
	private void lookSouth(Vec3d pos) {
		...
		client.player.lookAt(EntityAnchorArgumentType.EntityAnchor.FEET, vec3d);
		if (Config.get(Config.getNarratorkey()))
			client.player.sendMessage(new TranslatableText("narrate.nccbyshoaibkhan.south"), true);
	}
	...
	private void lookWest(Vec3d pos) {
		...
		client.player.lookAt(EntityAnchorArgumentType.EntityAnchor.FEET, vec3d);
		if (Config.get(Config.getNarratorkey()))
			client.player.sendMessage(new TranslatableText("narrate.nccbyshoaibkhan.west"), true);
	}
	...
	private void lookEast(Vec3d pos) {
		...
		client.player.lookAt(EntityAnchorArgumentType.EntityAnchor.FEET, vec3d);
		if (Config.get(Config.getNarratorkey()))
			client.player.sendMessage(new TranslatableText("narrate.nccbyshoaibkhan.east"), true);
	}
